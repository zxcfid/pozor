...
GUIDE_URL = "https://telegra.ph/Podrobnyj-gajd-po-ispolzovaniyu-WOLFOTCBOT-07-24"
...
LANGUAGES = {
    "ru": {
        ...
        "deal_seller_notification": "📢 Пользователь @{buyer_username} присоединился к сделке #{deal_id}.\nУспешные сделки: {buyer_deals}\n\n⚠️ Проверьте, что это тот же пользователь, с которым вы вели диалог ранее! Передавайте товар строго на аккаунт официального саппорта @wolfotcsupport. При передаче не на тот аккаунт мы не несем ответственности!",
